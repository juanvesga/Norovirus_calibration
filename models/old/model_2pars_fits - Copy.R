...
noro_model <- odin({
  ...
  lambda[,1]  <-lambda_1[i] * sus_vecnew[1]
  lambda[,2]  <-lambda_2[i] * sus_vecnew[2]
  lambda[,3]  <-lambda_3[i] * sus_vecnew[3]
  lambda[,4]  <-lambda_4[i] * sus_vecnew[4]
  ...
  crossp_GI <- 0.05#parameter(0.05)
  crossp_GII <- 0.05# parameter(0.05)
