...
# Note the -20 is to rescale the parameters and allow calibration pof negative values of lag with a log transformation
 ...
 cross_map[,] <-if (i==1) ( 
  ...
  n_R1_tot[, ,] <- Binomial(((R1[i, j] - n_ageoR1[i, j] - n_muR1[i, j] - n_R1_wane[i, j]) ), 
  ...
  n_R2_tot[, ,] <- Binomial(((R2[i, j] - n_ageoR2[i, j] - n_muR2[i, j] - n_R2_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R3_tot[, ,] <- Binomial(((R3[i, j] - n_ageoR3[i, j] - n_muR3[i, j] - n_R3_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R4_tot[, ,] <- Binomial(((R4[i, j] - n_ageoR4[i, j] - n_muR4[i, j] - n_R4_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R12_tot[, ,] <- Binomial(((R12[i, j] - n_ageoR12[i, j] - n_muR12[i, j] - n_R12_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R13_tot[, ,] <- Binomial(((R13[i, j] - n_ageoR13[i, j] - n_muR13[i, j] - n_R13_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R14_tot[, ,] <- Binomial(((R14[i, j] - n_ageoR14[i, j] - n_muR14[i, j] - n_R14_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R24_tot[, ,] <- Binomial(((R24[i, j] - n_ageoR24[i, j] - n_muR24[i, j] - n_R24_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R34_tot[, ,] <- Binomial(((R34[i, j] - n_ageoR34[i, j] - n_muR34[i, j] - n_R34_wane[i, j]) ), 
  p_SE[i,k]*cross_map[j,k])
  ...
  n_R4rd_tot[, ,] <- Binomial(((R4rd[i, j] -
   n_ageoR4rd[i, j] - 
   n_muR4rd[i, j] - 
   n_R4rd_wane[i, j]) ), p_SE[i,k]*cross_map[j,k])
